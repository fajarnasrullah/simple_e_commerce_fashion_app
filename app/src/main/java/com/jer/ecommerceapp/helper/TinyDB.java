...
package com.jer.ecommerceapp.helper;
...
public class TinyDB {
    ...
    public ArrayList<RecommendModel> getListObject(String key) {
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<RecommendModel> playerList = new ArrayList<RecommendModel>();

        for (String jObjString : objStrings) {
            RecommendModel player = gson.fromJson(jObjString, RecommendModel.class);
    ...
    public void putListObject(String key, ArrayList<RecommendModel> playerList) {
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for (RecommendModel player : playerList) {
