...
import com.jer.ecommerceapp.helper.TinyDB
...
class ManagmentCart(val context: Context) {
    ...
    fun insertFood(item: RecommendModel) {
    ...
    fun getListCart(): ArrayList<RecommendModel> {
        return tinyDB.getListObject("CartList") ?: arrayListOf()
    }

    fun minusItem(listFood: ArrayList<RecommendModel>, position: Int, listener: ChangeNumberItemsListener) {
    ...
    fun plusItem(listFood: ArrayList<RecommendModel>, position: Int, listener: ChangeNumberItemsListener) {
        listFood[position].numberInCart++
        tinyDB.putListObject("CartList", listFood)
        listener.onChanged()
    }
